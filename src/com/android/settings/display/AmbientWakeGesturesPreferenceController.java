...
import static android.provider.Settings.Secure.AMBIENT_WAKE_GESTURES;
...
public class AmbientWakeGesturesPreferenceController extends
    ...
    public boolean setChecked(boolean isChecked) {
        Settings.Secure.putInt(mContext.getContentResolver(), AMBIENT_WAKE_GESTURES, isChecked ? ON : OFF);
        return true;
    }
