...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.havoc.HavocUtils.mccCheck(getContext()) ?
                com.android.internal.util.havoc.HavocUtils.batteryTemperature(getContext(), true) + "°F" :
                com.android.internal.util.havoc.HavocUtils.batteryTemperature(getContext(), false) + "°C");
