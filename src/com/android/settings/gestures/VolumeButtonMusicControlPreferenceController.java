...
public class VolumeButtonMusicControlPreferenceController extends GesturePreferenceController {
    ...
    public boolean isChecked() {
        return LineageSettings.System.getIntForUser(mContext.getContentResolver(), VOLBTN_MUSIC_CONTROLS,
                OFF, UserHandle.USER_CURRENT) == ON;
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        return LineageSettings.System.putIntForUser(mContext.getContentResolver(), VOLBTN_MUSIC_CONTROLS,
