...
public class IntervalSeekBar extends SeekBar {
    ...
    public IntervalSeekBar(Context context, AttributeSet attrs) {
        ...
        TypedArray seekBarType = context.obtainStyledAttributes(attrs,
                R.styleable.IntervalSeekBarLiveDisplay, 0, 0);

        mMax = seekBarType.getFloat(R.styleable.IntervalSeekBarLiveDisplay_maxValue, 1.5f);
        mMin = seekBarType.getFloat(R.styleable.IntervalSeekBarLiveDisplay_minValue, 0.5f);
        mDefault = seekBarType.getFloat(R.styleable.IntervalSeekBarLiveDisplay_defaultValue, 1.0f);

        int digits = seekBarType.getInt(R.styleable.IntervalSeekBarLiveDisplay_digits, 0);
